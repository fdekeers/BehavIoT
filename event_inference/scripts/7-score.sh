...
python3 $PIPELINE_DIR/periodic_deviation_score.py -i $DATA_DIR/idle-2021-train-std/ -o $MODEL_DIR/time_score_newT_train_idle > $LOGS_DIR/7-score/1-deviation-score.log 2> $LOGS_DIR/7-score/1-deviation-score.error
